						...
						<div class="table-responsive country-table">
							<table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
								...
								<tbody>
									...
									@foreach(\App\Models\Invoice::latestInvoices()  as $invoice)
										<tr>
										...
										<td class="tx-right tx-medium tx-danger">{{ $invoice->serialNumbers_count }}</td>
									</tr>
										@endforeach
					...
					<div class="product-timeline card-body pt-2 mt-1">
						<ul class="timeline-1 mb-0">
							@php
								...
								$topEmployees = \App\Models\Admin::mostSerialTakers();
							@endphp
...
<div class="row row-sm row-deck">
    <div class="col-md-12 col-lg-4 col-xl-4">
        <div class="card card-dashboard-eight pb-2">
			...
			@php
            // TODO: Need full refactor after explaining
			...
			<div class="table-responsive country-table">
				<table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
					...
					<tbody>
                        ...
                        @endphp
							@foreach(\Spatie\Activitylog\Models\Activity::query()->with('causer')->latest()->take(5)->get() as $log)
							<tr>
								<td>{{ $log->id }}</td>
								<td>
