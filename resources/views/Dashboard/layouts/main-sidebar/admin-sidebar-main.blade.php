			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('admin.employees.index') }}">عرض الكل </a></li>
							<li><a class="slide-item" href="{{ route ('admin.employees.create') }}">اضافة موظف</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('admin.users.index') }}">عرض الكل </a></li>
							<li><a class="slide-item" href="{{ route ('admin.users.create') }}">اضافة منسق</a></li>
