			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide ">
						...
						<ul class="slide-menu">
							        <li><a class="slide-item" href="{{ route('products.index') }}">عرض منتجات</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('customers.index') }}">عرض الكل  </a></li>
							<li><a class="slide-item" href="{{route('customers.create') }}">اضافة</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('supplier.index') }}">عرض الكل</a></li>
							<li><a class="slide-item" href="{{route('supplier.create') }}">اضافة</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Invoices.index') }}">عرض الاوذون </a></li>
							<li><a class="slide-item" href="{{ route('Invoices.create')}}">اضافة الاذن</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('employee.index') }}">عرض الكل </a></li>
							<li><a class="slide-item" href="{{ route ('employee.create') }}">اضافة موظف</a></li>
						
							
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg><span class="side-menu__label">منسق</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('user.index') }}">عرض الكل </a></li>
							<li><a class="slide-item" href="{{ route ('user.create') }}">اضافة منسق</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('serial.index') }}">بحث عن  سيريال </a></li>
