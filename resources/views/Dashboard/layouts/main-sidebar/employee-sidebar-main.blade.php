			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@if ((Auth::user()->type == 1) )
                            <li><a class="slide-item" href="{{route('employeeinvoice.show',1)}}">تسليم الاذون  </a></li>
							@endif
							
							@if ((Auth::user()->type == 2) )
							<li><a class="slide-item" href="{{route('employeeinvoice.index')}}">استلام الاذون  </a></li>
							@endif

                            <li><a class="slide-item" href="{{route('Compinvoice')}}">قائمة الاذون المكتملة</a></li>
