                                ...
                                <select class="form-control select2" name="employee_id" style="width: 100%;">
                                    @foreach ($admins as $admin)
                                        <option value="{{ $admin->id }}"
                                            ...
                                            {{ $admin->name }}-{{ $admin->permission == 3 ? 'مندوب تسليم ' : 'امين مخزن ' }}
                                            -{{ $admin->id }} </option>
                                    @endforeach
                                </select>
                            </div>
                                    ...
                                    @if (isset($invoiceProducts) && count($invoiceProducts) > 0)
                                        @foreach ($invoiceProducts as $product)
                                            <tr>
                                                ...
                                                <td><input type="number" name="quantities[]" class="form-control"
                                                        value="{{ $product->quantity }}"></td>
                                                <td><button type="button" class="btn btn-danger remove-row">حذف</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
