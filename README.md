...
هذا المشروع يَستخدم رخصة MIT (راجع ملف `LICENSE` إن وُجد).

---

إذا أردت أضيف قسم نشر مفصّل (Docker / Forge / Env examples) أو ترجمة README إلى الإنجليزية، أخبرني وسأقوم بذلك.
