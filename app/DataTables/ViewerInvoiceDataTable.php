...
class ViewerInvoiceDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('code', function ($item) {
                return '<a href="' . route('viewer.invoices.show', $item->id) . '">' . $item->code . '</a>';
            })
     ...
     *
     * @param \App\Models\ViewerInvoice $model
    ...
    {
        return 'ViewerInvoice_' . date('YmdHis');
    }
}
