...
class UserInvoiceDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($item) {
                return view('Dashboard.User.Invoices._actions', ['Invoice' => $item]);
            })

            ->editColumn('code', function ($item) {
                return '<a href="' . route('user.invoices.show', $item->id) . '">' . $item->code . '</a>';
            })
     ...
     *
     * @param \App\Models\UserInvoice $model
    ...
    {
        return 'UserInvoice_' . date('YmdHis');
    }
}
